# Desafio técnico e-commerce [![CI](https://github.com/alanliveira/rd-station-interview/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/alanliveira/rd-station-interview/actions/workflows/ci.yml)
...
Você deve desenvolver utilizando a linguagem Ruby e framework Rails, uma API Rest que terá 4 endpoins que deverão implementar as seguintes funcionalidades:
...
Intalar a versão do ruby configurada para o projeto
```bash
# usando o mise https://mise.jdx.dev/getting-started.html
mise install

# usando o asdf - https://asdf-vm.com/
asdf install
```
...
```bash
cp cp.sample.env .env
```

Executar o banco de dados via docker
```bash
...
# Para ambientes de test
RAILS_ENV=test bin/rails db:setup

# Caso o comando não funcione de a permissão de execução para o arquivo chmod +x bin/rails
```

Executar a aplicação:
```bash
# certifique de ter o tmux instalado
overmind s
```
...
# Caso o comando não funcione de a permissão de execução para o arquivo chmod +x bin/rspec
```
